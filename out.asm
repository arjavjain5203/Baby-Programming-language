...
section .data
msg_27: db "THIS SHOULD NOT PRINT", 0
msg_24: db "--- 5. Comments Test ---", 0
msg_23: db "Loop Finished!", 0
msg_22: db "Counter:", 0
...
msg_26: db "=== TEST COMPLETE - EXITING ===", 0
msg_5: db "Subtraction (x - y = 5):", 0
msg_25: db "You should not see any errors from the hidden block above.", 0
msg_20: db "val is not 999 (Correct - moveon)", 0
msg_6: db "Multiplication (x * y = 50):", 0
msg_21: db "--- 4. Loops (wait) ---", 0
